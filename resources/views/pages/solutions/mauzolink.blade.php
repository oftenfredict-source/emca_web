...
<html lang="en">
    ...
    <head>
        ...
        <!-- ======== Page title ============ -->
        <title>MauzoLink - {{ config('company.legal_name') }}</title>
        <!--<< Favcion >>-->
    ...
    <body class="emca-solution-page mauzolink-page emca-solution-visa-page">
        ...
        @include('pages.solutions.partials.mauzolink-visa-details')
