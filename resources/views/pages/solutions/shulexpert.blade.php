...
<html lang="en">
    ...
    <head>
        ...
        <!-- ======== Page title ============ -->
        <title>ShuleXpert - {{ config('company.legal_name') }}</title>
        <!--<< Favcion >>-->
    ...
    <body class="emca-solution-page shulexpert-page emca-solution-visa-page">
        ...
        @include('pages.solutions.partials.shulexpert-visa-details')
