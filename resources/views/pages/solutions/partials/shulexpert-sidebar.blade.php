<div class="emca-solution-topbar row g-4 wow fadeInUp" data-wow-delay=".2s">
    <div class="col-lg-4">
        <div class="emca-topbar-card emca-topbar-product">
            ...
            <div>
                <h3>ShuleXpert</h3>
                <p>Integrated school management for Pre, Primary & Secondary schools in Tanzania.</p>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="emca-topbar-card emca-topbar-highlights">
            <h4>At a Glance</h4>
            <ul>
                <li><i class="fas fa-check"></i> Student & staff records</li>
                <li><i class="fas fa-check"></i> Fees, reports & parent portal</li>
                <li><i class="fas fa-check"></i> Android & iOS apps</li>
            </ul>
        </div>
    </div>
    <div class="col-lg-4">
