...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="PangishaLink solution by {{ config('company.name') }}">
        <!-- ======== Page title ============ -->
        <title>PangishaLink - {{ config('company.site_title', 'EmCa Techonologies') }}</title>
    ...
    <body class="emca-solution-page pangishalink-page emca-solution-visa-page">
        ...
        <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('{{ asset($solution['banner'] ?? $solution['image']) }}');">
            <div class="container">
                <div class="page-heading">
                    <h1 class="wow fadeInUp" data-wow-delay=".3s">{{ $solution['name'] }}</h1>
        ...
        @include('pages.solutions.partials.pangishalink-visa-details')
