...
<html lang="en">
    ...
    <head>
        ...
        <!-- ======== Page title ============ -->
        <title>WauminiLink - {{ config('company.legal_name') }}</title>
        <!--<< Favcion >>-->
    ...
    <body class="emca-solution-page wauminilink-page emca-solution-visa-page">
        ...
        @include('pages.solutions.partials.wauminilink-visa-details')
