...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="SACCOSSLink solution by {{ config('company.name') }}">
        <!-- ======== Page title ============ -->
        <title>SACCOSSLink - {{ config('company.site_title', 'EmCa Techonologies') }}</title>
    ...
    <body class="emca-solution-page saccosslink-page emca-solution-visa-page">
        ...
        @include('pages.solutions.partials.saccosslink-visa-details')
