...
<html lang="en">
    ...
    <body>
                ...
                <div class="marquee-inner to-left">
                    <ul class="marqee-list d-flex">
                        <li class="marquee-item style-2">
                            <span class="text-slider"><i class="fas fa-plane"></i></span><span class="text-slider text-style">Visa Processing</span>
                        </li>
                        <li class="marquee-item style-2">
                            <span class="text-slider"><i class="fas fa-plane"></i></span><span class="text-slider text-style">Help in Documentation</span>
                        </li>
                        <li class="marquee-item style-2">
                            <span class="text-slider"><i class="fas fa-plane"></i></span><span class="text-slider text-style">Immigrations</span>
                        </li>
                        <li class="marquee-item style-2">
                            <span class="text-slider"><i class="fas fa-plane"></i></span><span class="text-slider text-style">Travel Partners</span>
                        </li>
                        <li class="marquee-item style-2">
                            <span class="text-slider"><i class="fas fa-plane"></i></span><span class="text-slider text-style">Tours & Travel Agency</span>
                        </li>
                        <li class="marquee-item style-2">
                            <span class="text-slider"><i class="fas fa-plane"></i></span><span class="text-slider text-style">Visa Processing</span>
                        </li>
        ...
        <section class="country-section fix section-padding section-bg-3 bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/flag/lines-waves1.png') }}');">
            <div class="container">
                <div class="row g-4">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div class="country-box-items mt-0">
                            <div class="flag-thumb">
                                <img src="{{ asset('visaland-html/assets/img/flag/eng.png') }}" alt="img">
                            </div>
                            <div class="flag-content">
                                <h3><a href="{{ route('country.details') }}">England</a></h3>
                                <p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div class="country-box-items mt-0">
                            <div class="flag-thumb">
                                <img src="{{ asset('visaland-html/assets/img/flag/russ.png') }}" alt="img">
                            </div>
                            <div class="flag-content">
                                <h3><a href="{{ route('country.details') }}">Russia</a></h3>
                                <p>
                                    creative agency we believe in the Eid
                                    and innovation.
                                </p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div class="country-box-items mt-0">
                            <div class="flag-thumb">
                                <img src="{{ asset('visaland-html/assets/img/flag/bra.png') }}" alt="img">
                            </div>
                            <div class="flag-content">
                                <h3><a href="{{ route('country.details') }}">Brazil</a></h3>
                                <p>
                                    creative agency we believe in the Eid
                                    and innovation.
                                </p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                        <div class="country-box-items mt-0">
                            <div class="flag-thumb">
                                <img src="{{ asset('visaland-html/assets/img/flag/ger.png') }}" alt="img">
                            </div>
                            <div class="flag-content">
                                <h3><a href="{{ route('country.details') }}">Germany</a></h3>
                                <p>
                                    creative agency we believe in the Eid
                                    and innovation.
                                </p>
