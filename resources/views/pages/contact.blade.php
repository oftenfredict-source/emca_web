...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Contact {{ config('company.site_title', 'EmCa Techonologies') }}, Ben Bella Street, Moshi Municipality. Call {{ config('company.phone') }} or email {{ config('company.email') }}.">
        <!-- ======== Page title ============ -->
        <title>Contact Us - {{ config('company.site_title', 'EmCa Techonologies') }}</title>
    ...
    <body>
        ...
        <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('{{ site_image_url('banner_contact') }}');">
            <div class="container">
        ...
        <section class="contact-main-area section-padding emca-contact-page">
            <div class="container">
                                ...
                                <div class="row g-4 mt-3">
                                        ...
                                        <div class="info-items">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    {{ config('company.po_box') }}<br>
                                                    Postcode: {{ config('company.postcode') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".7s">
                                        <div class="info-items">
                                            ...
                                            <div class="content">
                                                <h5>Mail Us Now</h5>
                                                <a href="mailto:{{ config('company.email') }}" class="link">{{ config('company.email') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="map-section">
            <div class="google-map wow fadeInUp" data-wow-delay=".7s">
                <iframe src="{{ config('company.maps_embed_url') }}" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
            </div>
        </div>
