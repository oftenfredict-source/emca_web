                            ...
                            <ul>
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a target="_blank" href="#">{{ config('company.address') }}</a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="mailto:{{ config('company.email') }}"><span class="mailto:{{ config('company.email') }}">{{ config('company.email') }}</span></a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    <div class="offcanvas__contact-icon mr-15">
            ...
            <div class="row align-items-center">
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="single-team-items">
                        ...
                        <div class="team-content text-center">
                            <h5>
                                <a href="{{ route('team.details') }}">Salman Ahmed</a>
                            </h5>
                            <p>CEO & Founder</p>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="single-team-items">
                        ...
                        <div class="team-content text-center">
                            <h5>
                                <a href="{{ route('team.details') }}">Sonsil Macron</a>
                            </h5>
                            <p>CEO & Founder</p>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="single-team-items">
                        ...
                        <div class="team-content text-center">
                            <h5>
                                <a href="{{ route('team.details') }}">Kawser Ahmed</a>
                            </h5>
                            <p>CEO & Founder</p>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="single-team-items">
                        ...
                        <div class="team-content text-center">
                            <h5>
                                <a href="{{ route('team.details') }}">Sara Albert</a>
                            </h5>
                            <p>Consultant</p>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-11">
                            <div class="testimonial-items">
                                ...
                                <div class="client-info">
                                    ...
                                    <h6>Director, Business Innovations</h6>
                                    <span class="emca-testimonial-client">Client</span>
                                </div>
                                <div class="testimonial-content">
                                    <h3>                                      
                                        Outstanding work and great support. Exceeded our expectations!
                                    </h3>
                                    <div class="star">
                                        <span class="fas fa-star"></span>
                                        <span class="fas fa-star"></span>
                        ...
                        <div class="col-lg-11">
                            <div class="testimonial-items">
                                ...
                                <div class="client-info">
                                    ...
                                    <h6>Manager, Digital Services</h6>
                                    <span class="emca-testimonial-client">Client</span>
                                </div>
                                <div class="testimonial-content">
                                    <h3>                                      
                                        Professional service and reliable solutions. Great value for money!
                                    </h3>
                                    <div class="star">
                                        <span class="fas fa-star"></span>
                                        <span class="fas fa-star"></span>
            ...
            <div class="brand-wrapper">
                <div class="brand-carousel-active">
                    <div class="brand-image center">
                        <img src="{{ asset('visaland-html/assets/img/brand/01.png') }}" alt="brand-img">
                    </div>
                    <div class="brand-image center">
                        <img src="{{ asset('visaland-html/assets/img/brand/01.png') }}" alt="brand-img">
                    </div>
