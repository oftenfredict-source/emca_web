...
<html lang="en">
   ...
   <head>
    ...
    <body>
        ...
        <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('{{ asset('images/blog.jpg') }}');">
            <div class="container">
        ...
        <section class="news-section fix section-padding emca-home-news-section">
            <div class="container">
                ...
                @if(isset($latestPosts) && method_exists($latestPosts, 'links'))
                    <div class="mt-4 d-flex justify-content-center">{{ $latestPosts->links() }}</div>
                @endif
            </div>
        </section>
