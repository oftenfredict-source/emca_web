                ...
                <div class="team-details-wrapper">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="team-image bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/team/details-1.jpg') }}');"></div>
                        </div>
                        <div class="col-lg-5 mt-5 mt-lg-0 wow fadeInUp" data-wow-delay=".5s">
                            <div class="team-details-content">
                                ...
                                <a href="{{ route('contact') }}" class="theme-btn mt-5">
                                    <span class="mb-0">
                                        Get a Free Quate
                                        <i class="fas fa-chevron-right"></i>
                                    </span>
                            ...
                            <div class="get-touch-items">
                                ...
                                <div class="contact-items">
                                    ...
                                    <div class="contact-info wow fadeInUp" data-wow-delay=".5s">
                                        <h4>Email</h4>
                                        <h5><a href="mailto:info@example.com" class="link">info@example.com</a></h5>
                                    </div>
                                </div>
                                <div class="contact-items">
                                    <div class="contact-info wow fadeInUp" data-wow-delay=".3s">
