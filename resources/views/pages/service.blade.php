...
<html lang="en">
    ...
    <body>
        ...
        <header class="header-section-3">
            ...
            <section class="service-section fix section-padding emca-service-listing-section">
                <div class="container">
                    <p class="emca-listing-intro wow fadeInUp">ICT Services to Power Your Digital Growth</p>
                    <div class="service-wrapper p-0">
                        <div class="row g-4 emca-service-cards-grid">
                            @foreach (config('emca-services') as $slug => $item)
            ...
            <div class="footer-widgets-wrapper">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-4 ps-lg-5 col-sm-6 col-md-3 col-lg-3 wow fadeInUp" data-wow-delay=".8s">
