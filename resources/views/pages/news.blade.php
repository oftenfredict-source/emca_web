...
<html lang="en">
   ...
   <head>
    ...
    <meta name="description" content="VisaLand - Immigration and Visa Consulting Html Template">
    <!-- ======== Page title ============ -->
    <title>Visaland - Immigration & Visa Consulting HTML Template</title>
    <!--<< Favcion >>-->
    <link rel="shortcut icon" href="{{ asset('visaland-html/assets/img/preloader.svg') }}">
    <!--<< Bootstrap min.css >>-->
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="blog-posts">
                                <div class="single-blog-post">
                                    <div class="post-featured-thumb bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/news/post-1.jpg') }}');">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h2 class="title-anim">
                                         ...
                                         <a href="{{ route('news.details') }}" class="theme-btn mt-4 line-height">
                                            <span>READ MORE <i class="fas fa-chevron-right"></i></span>
                                         </a>
                                    </div>
                                </div>
                                <div class="single-blog-post">
                                    <div class="post-featured-thumb bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/news/post-2.jpg') }}');">
                                ...
                                <div class="single-blog-post">
                                    <div class="post-featured-thumb bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/news/post-3.jpg') }}');">
                                    ...
                                    <div class="post-content text-white bg-cover">
                                        <div class="quote-content">
                                            ...
                                            <div class="quote-text">
                                                <h2 class="title-anim">Excepteur sint occaecat cupida tat non proident, sunt in.</h2>
                                                <div class="post-meta">
                                                    <span><i class="fal fa-comments"></i>35 Comments</span>
                                                    <span><i class="fal fa-calendar-alt"></i>24th March 2024</span>
                                                </div>
