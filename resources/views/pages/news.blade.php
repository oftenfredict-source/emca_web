                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <div class="blog-posts">
                                @include('partials.blog-posts-list', ['posts' => $posts ?? collect()])
                            </div>
                        </div>
                            ...
                            <div class="main-sidebar">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="tagcloud">
                                        ...
                                        <a href="{{ route('news') }}">Education</a>
                                        <a href="{{ route('news') }}">Immigration</a>
                                        <a href="{{ route('news') }}">Travel</a>
                                        <a href="{{ route('news') }}">Visa</a>
                                    </div>
                                </div>
                            </div>
                        </div>
