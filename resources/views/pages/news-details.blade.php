                            ...
                            <div class="blog-post-details border-wrap mt-0">
                                <div class="single-blog-post post-details mt-0">
                                    <div class="post-content pt-0">
                                        <h2 class="mt-0 title-anim">Mind-Blowing Reasons Why Agency Is Using This Technique For Exposure.</h2>
                                        ...
                                        <img src="{{ asset('visaland-html/assets/img/news/post-4.jpg') }}" alt="blog__img" class="single-post-image">
                                        <h2 class="title-anim">You Should Experience Agency At Least Once In Your Lifetime And Here's Why.</h2>
                                        <p>
                                        ...
                                        <img class="alignleft" src="{{ asset('visaland-html/assets/img/news/post-5.jpg') }}" alt="blog__img">
                                        <p>
                                            With worldwide annual spend on digital advertising surpassing $325 billion, it’s no surprise that different 
                                            approaches to online marketing are becoming available. One of these new approaches is performance marketing 
                                            or digital performance marketing. Keep reading to learn all about performance marketing
                                ...
                                <div class="row tag-share-wrap">
                                    <div class="col-lg-8 col-12">
                                        <h4>Releted Tags</h4>
                                        <div class="tagcloud">                                   
                                            <a href="{{ route('news.details') }}">Development</a>
                                            <a href="{{ route('news.details') }}">Visa</a>
                                            <a href="{{ route('news.details') }}">Tech</a>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="comments-item-list">
                                        <li class="single-comment-item">
                                            <div class="author-img">
                                                <img src="{{ asset('visaland-html/assets/img/news/author_img2.jpg') }}" alt="img">
                                            </div>
                                        ...
                                        <li class="single-comment-item">
                                            <div class="author-img">
                                                <img src="{{ asset('visaland-html/assets/img/news/author_img3.jpg') }}" alt="img">
                                            </div>
                                            <div class="author-info-comment">
                                                <div class="info">
                                            ...
                                            <ul class="replay-comment">
                                                <li class="single-comment-item">
                                                    <div class="author-img">
                                                        <img src="{{ asset('visaland-html/assets/img/news/author_img4.jpg') }}" alt="img">
                                                    </div>
                                                    <div class="author-info-comment">
                                                        <div class="info">
                            ...
                            <div class="main-sidebar">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="popular-posts">
                                        <div class="single-post-item">
                                            <div class="thumb bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/news/pp1.jpg') }}');"></div>
                                            <div class="post-content">
                                                <h5><a href="{{ route('news.details') }}">
                                        ...
                                        <div class="single-post-item">
                                            <div class="thumb bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/news/pp2.jpg') }}');"></div>
                                            <div class="post-content">
                                                <h5><a href="{{ route('news.details') }}">Top 25 Most In Demand Jobs In Canada</a></h5>
                                                <div class="post-date">
                                        ...
                                        <div class="single-post-item">
                                            <div class="thumb bg-cover" style="background-image: url('{{ asset('visaland-html/assets/img/news/pp3.jpg') }}');"></div>
                                            <div class="post-content">
                                                <h5><a href="{{ route('news.details') }}">The Human Rights And Study Visa Programs</a></h5>
                                                <div class="post-date">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="widget_categories">
                                        <ul>
                                            <li><a href="{{ route('news') }}">Abroad Study <span>23</span></a></li>
                                            <li><a href="{{ route('news') }}">Green card <span>24</span></a></li>
                                            <li><a href="{{ route('news') }}">PR Applicants <span>11</span></a></li>
                                            <li><a href="{{ route('news') }}">Travel Insurance <span>05</span></a></li>
                                            <li><a href="{{ route('news') }}">Visa Consultancy <span>06</span></a></li>
                                            <li><a href="{{ route('news') }}">Work Permits <span>10</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="single-sidebar-widget">
                                ...
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="tagcloud">
                                        <a href="{{ route('news') }}">Business</a>     
                                        <a href="{{ route('news.details') }}">Consulting</a>
                                        <a href="{{ route('news.details') }}">Education</a>
                                        <a href="{{ route('news.details') }}">Immigration</a>
                                        <a href="{{ route('news.details') }}">Travel</a>
                                        <a href="{{ route('news.details') }}">Visa</a>
                                    </div>
                                </div>
                            </div>
