                        ...
                        <div class="col-lg-8">
                            <div class="country-details-items">
                                ...
                                <div class="details-image">
                                    <img src="{{ asset('visaland-html/assets/img/country/details-1.jpg') }}" alt="img">
                                </div>
                                <p class="mb-3">
                                    ...
                                    only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. dummy text ever since the 1500s, when an
                                    unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not
                                ...
                                <div class="row g-4 mt-4 align-items-center">
                                    <div class="col-lg-6">
                                        <div class="thumb-2">
                                            <img src="{{ asset('visaland-html/assets/img/country/details-2.jpg') }}" alt="img">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="content">
                                            ...
                                            <p>
                                                Need something changed or is there something not quite working the way you envisaged? Is your van a
                                                little old and tired and need refreshing? Lorem Ipsum is simply dummy text of the printing and typesetting
                                                industry. tired and need refreshing? Lorem Ipsum is simply dummy text of the printing and typesetting
                                                industry.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-4 mt-5 align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="thumb-2">
                                            <img src="{{ asset('visaland-html/assets/img/country/details-3.jpg') }}" alt="img">
                                            <div class="video-box">
