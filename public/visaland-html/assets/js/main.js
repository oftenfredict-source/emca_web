...
(function($) {
    ...
    $.fn.loading = function() {
        ...
        $(this).each(function() {
            ...
            const displayText = $target.data('display') !== undefined ? String($target.data('display')) : (opts.percent + '%');

            $target.append('<div class="background"></div><div class="rotate"></div><div class="left"></div><div class="right"></div><div class=""><span>' + displayText + '</span></div>');
